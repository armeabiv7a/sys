...
CFLAGS="-g -O2 -pipe -Wall -Wextra -Wno-attributes -std=gnu11 -ffreestanding -fno-stack-protector -fno-stack-check -fno-lto -fno-PIC -ffunction-sections -fdata-sections -m64 -march=x86-64 -mabi=sysv -mno-80387 -mno-mmx -mno-sse -mno-sse2 -no-pie -mno-red-zone -mcmodel=kernel -Icore/include"
NASMFLAGS="-f elf64 -Wall"
LDFLAGS="-m elf_x86_64 -nostdlib -no-pie -static -z max-page-size=0x1000 --gc-sections -T $SRC_DIR/linker.ld"
...
#qemu-system-x86_64 -d int,cpu_reset -D qemu.log -cdrom $ISO_ROOT/image.iso -m 512M -smp 2 -net none -rtc base=utc
qemu-system-x86_64 -cdrom $ISO_ROOT/image.iso -m 521M -smp 2 -net none -rtc base=utc
